...
export const Supported = () => {
  ...
  return (
    <Container className='pb-40 lg:pb-60 xl:pb-80 grid lg:grid-cols-3 gap-8'>
            ...
            <AccordionContent>
              <Accordion type='multiple' className='space-y-4'>
                ...
                <AccordionItem value='2 series'>
                  ...
                  <AccordionContent className='space-y-6'>
                    <AccordionContentItem label='F22, F23, F87' year='2013+' />
                ...
                <AccordionItem value='3 series'>
                  ...
                  <AccordionContent className='space-y-6'>
                    ...
                    <AccordionContentItem
                      ...
                      year='2011-2019'
                    />
                    <AccordionContentItem label='G20, G21, G80' year='2019+' />
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value='5 series'>
                  ...
                  <AccordionContent className='space-y-6'>
                    ...
                    <AccordionContentItem
                      ...
                      year='2010-2017'
                    />
                    <AccordionContentItem label='G30, G31, F90' year='2017+' />
                  </AccordionContent>
                </AccordionItem>
