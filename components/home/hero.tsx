  ...
  return (
    <section>
      <Container className='flex flex-col items-center'>
        <div className='rounded-xl border border-zinc-200/10 bg-zinc-800/80'>
          <div className='grid sm:grid-cols-2'>
            <div className='relative'>
              ...
              <p className='absolute left-2 top-2 rounded-xl border-zinc-200/10 bg-zinc-800/80 p-2 px-3 text-sm md:text-base'>
                {language === 'cs' && 'Ahoj, já jsem Daniel'}
                {language === 'en' && "Hi, I'm Daniel"}
              </p>

              <div className='absolute bottom-2 right-2 flex items-center gap-2 rounded-xl border border-zinc-200/10 bg-zinc-800/80 p-2 text-xs sm:text-sm md:text-base'>
            ...
            <div className='flex flex-col p-4'>
              <div className='space-y-1 text-2xl font-bold md:space-y-2 md:text-3xl lg:text-5xl 2xl:text-6xl'>
                <p className='flex items-center justify-between gap-4 text-fuchsia-200'>
                  {language === 'cs' && 'Vývojář'}
                ...
                <p className='flex items-center justify-between gap-4 text-green-200'>
                ...
                <p className='flex items-center justify-between gap-4 text-sky-200'>
                ...
                <p className='flex items-center justify-between gap-4 text-yellow-200'>
                  {language === 'cs' && 'Tvůrce'}
                  {language === 'en' && 'Creator'}
                ...
                <p className='flex items-center justify-between gap-4 text-indigo-200'>
        ...
        <p className='mt-4 text-justify md:text-lg xl:text-2xl'>
