        ...
        <div className='relative h-[80vh] w-full mt-28 lg:mt-32'>
          <div className='flex justify-center flex-col w-full h-full p-4'>
            ...
            <div className='flex justify-center'>
              <div className='flex items-center bg-zinc-800/70 px-4 py-2 border border-zinc-600 rounded-lg gap-2 mt-2 w-full justify-center sm:w-auto text-zinc-400'>
                <MapPin size={22} />
            ...
            {language === 'en' && (
              <p className='max-w-[52ch] mt-12 text-zinc-400 text-justify mx-auto'>
            ...
            {language === 'cs' && (
              <p className='max-w-[50ch] mt-12 text-zinc-400 text-justify mx-auto'>
