        ...
        <div className='grid xl:grid-cols-2 gap-8 xl:gap-20'>
          ...
          <div className='sticky top-20 h-min'>
            <p className='md:text-lg lg:text-xl text-zinc-700 dark:text-zinc-400 text-justify'>
              {language === 'en' && (
                <>
                  I&apos;m just a young kid who wants to make his dreams come
                  true and I believe that programming 💻 will lead me to it one
                  day. In 2015, I started designing and photography 📸. I first
                  encountered Programming 🖥️ in 2019 and was immediately hooked.
                  Since then I&apos;ve managed to create dozens of projects,
                  both for myself and for clients. Some of my favourites include
                  the{' '}
                  <Link
                  ...
                  have created several applications for the Pilsen Regional
                  Office 👔, I have given educational lectures for children 🧑‍🏫
                  and I have successfully passed the Microsoft Office Specialist
                  exams 📖 in PowerPoint 🟠 and Word 🔵 at the bett 2023 event
                  in London.
                </>
              )}
              {language === 'cs' && (
                <>
                  ...
                  programování 💻 mě k tomu jednou dovede. V roce 2015 jsem
                  začal s designem a fotografováním 📸. S Programováním 🖥 jsem
                  se poprvé setkal v roce 2019 a hned mě to pohltilo. Od té doby
                  jsem stihl vytvořit desítky projektů, ať už sám pro sebe, tak
                  i pro klienty. Mezi mé nejoblíbenější patří web{' '}
                  <Link
                    href='https://planetopedia.agency'
                    target='_blank'
                    className='relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-[3px] after:bg-purple-500 hover:text-purple-500 dark:hover:text-purple-500 transition font-bold dark:text-zinc-200 text-zinc-800'
                  ...
                  několik aplikací pro úřad plzeňského kraje 👔, vedl jsem
                  výukové přednášky 🧑‍🏫 pro děti a také jsem úspěšně absolvoval
                  Microsoft Office Specialist zkoušky 📖 z PowerPointu 🟠 a
                  Wordu 🔵 na akci bett 2023 v Londýně.
                </>
              )}
            </p>
          </div>
