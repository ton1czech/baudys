      ...
      <Container>
        <div className='grid grid-cols-2 gap-6 md:hidden'>
          <div className='flex flex-col gap-6'>
            {gallery.slice(0, itemsPer2Column).map((item) => (
              <Photo key={item} photo={item} />
            ))}
          </div>
          <div className='flex flex-col gap-6'>
            {gallery.slice(itemsPer2Column).map((item) => (
              <Photo key={item} photo={item} />
            ))}
          </div>
        </div>
        ...
        <div className='hidden grid-cols-3 gap-6 md:grid'>
          <div className='flex flex-col gap-6'>
            {gallery.slice(0, itemsPer3Column).map((item) => (
              <Photo key={item} photo={item} />
            ))}
          </div>
          <div className='flex flex-col gap-6'>
            {gallery.slice(itemsPer3Column, itemsPer3Column * 2).map((item) => (
              <Photo key={item} photo={item} />
            ))}
          </div>
          <div className='flex flex-col gap-6'>
